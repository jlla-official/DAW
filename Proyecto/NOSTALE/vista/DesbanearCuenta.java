...
public class DesbanearCuenta extends JFrame {

	private JPanel contentPane;
	private JTextField inputUsuario;

	public DesbanearCuenta() {
		...
		JLabel labelBanearCuenta = new JLabel("DESBANEAR CUENTA");
		labelBanearCuenta.setFont(new Font("Tahoma", Font.BOLD, 17));
		labelBanearCuenta.setBounds(113, 21, 179, 21);
		...
		botonAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String resultado = new CuentaControlador().desbanearCuenta(usuario);
				
				if(resultado != null) {
					new MensajeEmergente(resultado);
				} else {
					new MensajeEmergente("Cuenta desbaneada");
				}
